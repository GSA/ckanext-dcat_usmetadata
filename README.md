...
----- | ----------- | -------
unit tests for the JS app | Make sure you run this command inside _./metadata-app_ folder. To run without watching use `--watchAll=false` flag | `yarn test --watchAll=false`
